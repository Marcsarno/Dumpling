...
try{
 await mkdir('artifacts/pop-milestone',{recursive:true});await page.goto('http://127.0.0.1:5173/scripts/pop-core.html');await page.locator('[data-start]').waitFor({state:'visible'});
