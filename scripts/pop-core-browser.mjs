...
await page.goto('http://127.0.0.1:5173/scripts/pop-core.html');await page.locator('[data-start]').tap();await learnFirstChain(page);await page.waitForFunction(()=>window.pop.snapshot().state==='playing');const cdp=await context.newCDPSession(page);
