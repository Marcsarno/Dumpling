...
var init_LayoutBridge = __esm({
  "src/editor/LayoutBridge.ts"() {
    ...
    artTasks = [];
    scopes = /* @__PURE__ */ new Set(["Bedroom", "Maple cottage", "Cleanup props", "Daily routines", "Classroom trading club"]);
  }
});
...
var init_IsometricCamera = __esm({
  "src/game/IsometricCamera.ts"() {
    "use strict";
    CAMERA_PRESETS = { EXPLORE: { zoom: 1 }, CHORE: { zoom: 0.76 }, REVIEW: { zoom: 0.65 }, BOX_OPENING: { zoom: 0.7 }, TRADE: { zoom: 0.85 } };
...
var init_Marc = __esm({
  "src/game/Marc.ts"() {
    ...
    init_house();
    init_primitives();
    SEAT = new Vec331(4.5, 0, 7.35);
    YAW = -35;
    FORWARD = new Vec331(Math.sin(YAW * Math.PI / 180), 0, Math.cos(YAW * Math.PI / 180));
